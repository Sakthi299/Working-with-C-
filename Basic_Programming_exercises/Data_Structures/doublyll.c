...
#include<stdlib.h>
struct node 
{ struct node *next; int data; struct node *prev; }; 
...
new_node -> data = num;
 ...
 while(ptr -> data != val) 
  ptr = ptr -> next; 
 new_node -> next = ptr; //START
 new_node -> prev = ptr-> prev; 
 ptr -> prev -> next = new_node; // 
 ptr -> prev = new_node; //END
 return start; } 
 ...
 while(ptr -> data != val)  
  ptr = ptr -> next; 
 new_node -> prev = ptr; //START
 new_node -> next = ptr -> next; 
 ptr -> next -> prev = new_node; 
 ptr -> next = new_node; //END
 return start; }
 ...
 while(ptr -> data != val)  
  ptr = ptr -> next; 
 temp = ptr -> prev; 
 if(temp == start)         //Necessary to change START node
 {
 	start=start->next;
 	start->prev=NULL;
 }
